...
public class RestAPI {
	...
	public RestAPI withCredentials(UsernamePasswordCredentials credentials) {
		this.credentials = credentials;
		return this;
	}

	public RestAPI withProtocol(String protocol) {
	...
	public RestAPI withPort(int port) {
		this.port = port;
		return this;
	}
	...
	public List<ModuleResponse> modules() throws Exception {
		return get(v1(MODULES),
				objectMapper.getTypeFactory().constructCollectionType(List.class, ModuleResponse.class));
	}
	...
	public ActionResponse actionStatus(String actionUID) throws Exception {
		return get(v1(ACTIONS, actionUID), ActionResponse.class);
	}

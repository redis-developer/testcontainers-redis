...
public class ProvisionJRX {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Database db = Database.name("test4").port(12000).ossCluster(true).shardPlacement(Database.ShardPlacement.SPARSE).modules(Database.Module.SEARCH, Database.Module.GEARS, Database.Module.TIMESERIES).build();
